...
router = "%s/yolov4_pedestrian_last.weights"%(os.getcwd())

#read .cfg .weights
net = cv2.dnn.readNetFromDarknet("/home/shon/code/PAFBenchmark/pedestrian_detection/yolov4_pedestrian.cfg",router)
...
#讀取分類檔、設定標記框顏色
classes = [line.strip() for line in open("/home/shon/code/PAFBenchmark/pedestrian_detection/pes.names")]
colors = [(0,0,255),(255,0,0),(0,255,0)]

#先讀取要測試圖片
images_list = []
for img in os.listdir("/home/shon/code/PAFBenchmark/pedestrian_detection/test"):
    if img.endswith(".jpg"):
...
for st in images_list:
    ...
    boxes = []
    boxes2 = []
    img_st = "/home/shon/code/PAFBenchmark/pedestrian_detection/test/%s.jpg"%(st)
    txt_st = "/home/shon/code/PAFBenchmark/pedestrian_detection/test/%s.txt"%(st)
    print(img_st)
    print(txt_st)
